...
?>
<body style="background-image: url('pelengkap/gambar/18.jpg');">
    <div class="container">
        <div class="row">
		    ...
		    <div class="panel-heading">
			<p>Login Dengan :</p>
			<p><i class="fa fa-user fa-fw"></i> admin</p>
                        <p><i class="fa fa-lock fa-fw"></i> admin</p>
                        <p><i class="fa fa-exclamation  fa-fw"></i> Ini open: jangan ganti sandinya.</p>
                    </div>
